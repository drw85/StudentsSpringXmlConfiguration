...
<div class="container">
    <div class="row justify-content-center py-3">
        ...
        <div class="form-group text-center form-check-inline">
            ...
            <input type="text" value="${group.id}" class="form-control" id="idGroup" name="idGroup" disabled>
        </div>
        <div class="form-group text-center form-check-inline">
    ...
    <div class="row justify-content-center">
        <div class="h4">Студенты группы</div>
    </div>
    <div class="row justify-content-center">
        <div class="list-group text-center">
            <c:forEach items="${students}" var="student">
                <a href="${pageContext.request.contextPath}/showStudent?id=${student.id}"
                   class="list-group-item list-group-item-action">${student.firstname} ${student.lastname}</a>
            </c:forEach>
        </div>
    </div>
</div>
