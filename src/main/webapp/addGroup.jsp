...
<div class="container">
    <div class="row">
        <div class="col-md-12 text-center py-3">
            <div class="h2">ДОБАВИТЬ НОВУЮ ГРУППУ</div>
        </div>
    </div>
    <div class="row justify-content-center pt-3">
        <form action="${pageContext.request.contextPath}/addGroup" method="post" name="newGroupForm">
            <div class="form-group text-center">
                <label for="name">Имя группы</label>
                <input type="text" class="form-control" id="name" name="name">
            </div>
            <div class="form-group text-center">
                <select id="courseSelector" name="course" class="form-control">
                    <c:forEach items="${coursesVars}" var="course" varStatus="loop">
